...
<div class="offer-banner-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-xs-12 col-md-4 col-sm-4 wow"><a href="http://127.0.0.1:8000/san-pham?cat_id=41"><img alt="offer banner1" src="{{asset('frontend/images/dt.jpg')}}" width="372px" height="280px"></a></div>
            <div class="col-lg-4 col-xs-12 col-md-4 col-sm-4 wow"><a href="http://127.0.0.1:8000/san-pham?cat_id=42"><img alt="offer banner1" src="{{asset('frontend/images/aab.jpg')}}" width="372px" height="280px"></a></div>
            <div class="col-lg-4 col-xs-12 col-md-4 col-sm-4 wow"><a href="http://127.0.0.1:8000/san-pham?cat_id=43"><img alt="offer banner1" src="{{asset('frontend/images/loa.jpg')}}" width="372px" height="280px"></a></div>
        </div>
    </div>
</div>
